...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-gray-200 relative">
      ...
      <a href="https://github.com/doccaz/cloud-init" target="_blank" rel="noreferrer" className="github-corner absolute bottom-0 right-0 z-50" aria-label="View source on GitHub">
